...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('product.store1') }}" id="dataForm" enctype="multipart/form-data">
    <div class="row">
      <!-- left column -->      
      <div class="col-md-12">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6 none-padding pleft-5" >                  
                            ...
                            <select class="form-control" name="amount_unit_id" id="amount_unit_id">
                              ...
                              <option value="{{ $value->id }}"
                              {{ old('amount_unit_id') == $value->id ? "selected" : "" }}                           
                     ...
                     <div role="tabpanel" class="tab-pane" id="settings">
                        <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                          ...
                          <div class="col-md-12" style="text-align:center">
                            ...
                            @for($i=1;$i<=5;$i++)
                            <input type="file" name="file-images[]" style="margin-left: 450px; margin-bottom: 20px" />
                            @endfor
                          </div>
