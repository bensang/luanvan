          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            @if( $items->count() > 0 )
              ...
              <tr id="row-{{ $item->id }}">
                ...
                <td>
                  <img class="img-thumbnail lazy" src="{!!asset('uploads/duan/'.$item->image)!!}" width="145" style="width: 145px; height: 100px">
                </td>        
                <td>                  
                  <a href="">{{ $item->title }}</a>
                </td>
                <td style="white-space:nowrap"> 
                  <a class="btn btn-default btn-sm" href="{{ route('news-detail', [$item->cate_id, $item->id ]) }}" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>                 
