...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <a class="btn btn-primary btn-sm" href="{{ route('news-detail', [$detail->cate_id, $detail->id ]) }}" target="_blank" style="margin-top:-6px"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>
    <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('articles.update') }}">
    <div class="row">
      <!-- left column -->
            ...
            <div class="box-body">
              ...
              @endif                
                ...
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-9">
                    <img id="thumbnail_image" src="{!!asset('uploads/duan/'.$detail->image)!!}" class="img-thumbnail" width="145" height="85">
                ...
                <div class="form-group">
                  <label>Mô tả</label>
                  <textarea class="form-control" rows="6" name="description" id="editor1">{{ $detail->description }}</textarea>
                </div>       
            </div>          
