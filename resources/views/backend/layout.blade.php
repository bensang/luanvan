...
<head>
  ...
  <title>batdongsan.com.vn | Dashboard</title>
...
<div class="wrapper">
  ...
  <div style="display: none" id="box_uploadimages">
    <div class="upload_wrapper block_auto">
        ...
        <form id="upload_files_new" method="post" enctype="multipart/form-data" enctype="multipart/form-data" action="">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="mailto:sanglai190997@gmail.com">sanglai190997@gmail.com</a>.</strong> All rights
    reserved.
  </footer>

  <!-- Add the sidebar's background. This div must be placed
       immediately after the control sidebar -->
<input type="hidden" id="route_update_order" value="">
<input type="hidden" id="route_get_slug" value="">
