...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <a class="btn btn-primary btn-sm" href="{{ route('detail-project', ['id' => $detail->id]) }}" target="_blank" style="margin-top:-6px"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>
    <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('projects.update') }}">
    <div class="row">
      <!-- left column -->
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
              ...
              @endif                                                   
                ...
                <div class="form-group">
                  <label>Mô tả</label>
                  <textarea class="form-control" rows="6" name="description" id="editor1">
                    <?php 
