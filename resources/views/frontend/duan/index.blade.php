			...
			<div class="col-sm-6 col-xs-6">
				<div class="project-item">
					<div class="project-img">
					    <a href="{{ route('detail-project', $value->id ) }}" title="{{ $value->name }}">
					        <img src="{!!asset('uploads/duan/'.$value->image)!!}" alt="{!! $value->name !!}" style="height: 228px; width: 304px">
					    </a>
					</div>
					<div class="project-desc">
			            <div class="project-name">
			                <h4><a href="{{ route('detail-project', $value->id ) }}" title="{!! $value->name !!}">{!! $value->name !!}</a></h4>
			            </div>
